...
public class Fuzz_effect extends Activity {
	private static final String TAG = "FuzzEffect";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//initSystemServices();
		setContentView(R.layout.activity_fuzz_effect);
	...
	private void start() {
		if (!pdService.isRunning()) {
			Intent intent = new Intent(Fuzz_effect.this,
					Fuzz_effect.class);
			pdService.startAudio(intent, R.drawable.icon,
					"Fuzz_effect", "Return to Fuzz_effect.");
		}
	}
	...
	//Changes the amplifier value when the configure button is pressed
	public void configure(View view){
		TextView amplify =(TextView)findViewById(R.id.amplifytextview);
		Float a =Float.valueOf(amplify.getText().toString());
		PdBase.sendFloat("amplify", a );
	}
}
